    ...
    <>
      ...
      >
        <div className="jobInfo">
          <label htmlFor="company" className="whLabel">
            Company Name:
          </label>
          <input
            type="text"
        ...
        <div className="jobInfo">
          <label htmlFor="jobTitle" className="whLabel">
            Job Title:
          </label>
          <input
            type="text"
        ...
        <div className="jobInfo">
          <label htmlFor="tasks" className="whLabel">
            Responsibilities:
          </label>
          <input
            type="text"
          ...
          ></input>
          <button id="taskButton" type="button" onClick={addTask}>
            +
          </button>
        </div>
        <div id="taskListCtr">
        ...
        <div id="jobBtnCtr">
          <button
            ...
            onClick={(e) => {
              e.preventDefault();
              handleSubmit(company, title, tasks, startDate, endDate);
            }}
          >
            Add
          </button>
